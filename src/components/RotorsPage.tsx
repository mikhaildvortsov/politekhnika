            ...
            <div className="space-y-6">
              <AnimatedElement animationType="fade-right" delay={300}>
                ...
                <p className="text-2xl text-gray-700 leading-relaxed mb-6">
                  Роторные дождеватели — это надежное решение для автоматического полива средних и больших по площади газонов. Благодаря вращающейся струе воды обеспечивается равномерное орошение территории с высокой эффективностью использования воды.
                </p>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-2xl text-gray-700 leading-relaxed">
                      Внутренняя присоединительная резьба 3/4"(дюйма)
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-green-600 mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-2xl text-gray-700 leading-relaxed">
                      8 стандартных и 4 низкоугловых сопла в комплекте для различных по ширине участков
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-green-600 mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
