          ...
          <AnimatedElement animationType="fade-up" delay={200}>
            <div className="max-w-4xl mx-auto space-y-6">
              <p className="text-2xl text-gray-700 leading-relaxed">
                При проектировании системы автополива для крупного парка или сквера, помимо прочих, встают два главных вопроса – обеспечение необходимого водоснабжения и организация централизованного управления всей системой автоматического полива. Многолетний опыт проектирования, расчетов и взаимодействия с городскими властями по всей России, позволяют нам не только быстро выпустить пакет проектно-сметной документации, но и выполнить работы по монтажу и пусконаладке подобных систем полива.
              </p>
            </div>
          </AnimatedElement>
        </div>
